...
//1. file text format mein hai ki mahi 

const isttextfile = (filepath: string): boolean => {
...
export class AgentExecutor {
    ...
    // private => bahaar ka koi access nahi kar sakta bs class ke andar  wale ko hi access hoga
